-- ============================================================
-- Model: stg_csv__bandcamp_collection
-- Layer: Staging
-- Description: Bandcamp purchased collection from the internal fan collection
--              API, cleaned and typed. raw_json is preserved because the API is
--              undocumented and fields can change without notice (ADR-018).
-- Source: csv.bandcamp_collection
...
source AS (
    SELECT * FROM {{ source('csv', 'bandcamp_collection') }}
),
